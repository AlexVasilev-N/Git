...
Данная команда позволяет посмотреть историю веток. 
...
>>> git clone https://github.com/Name/File

Команда позволящаю скачать удаленный репозиторий. 

## Отправка данных в удаленный репозиторий 

> git push 

Команда позволяющая отправить данные на удаленный репозиторий. 

## Стягивание с удаленного репозитория 

> git pull 

Команда позволяющая стунять из удалнного репозитория данные. 

**Внимание!** Данная команда при скачивании данных объединяет их (merge) c уже имеющимися данными в локльном репозитории. 
